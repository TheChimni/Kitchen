...
RecipePhoto.create!(:recipe => recipe1, :title => 'Baingan ka Bharta', :image => File.open('db/pictures/Baingan.jpeg'))
recipe2 = Recipe.create!(:title => 'Dal Makhni',
               ...
               :ingredient_list => 'secret',
               :preparation_method => 'secret')
RecipePhoto.create!(:recipe => recipe2, :title => 'Dal Makhni', :image => File.open('db/pictures/ShimlaMirch.jpeg'))
recipe3 = Recipe.create!(:title => 'Bhindi',
               ...
               :ingredient_list => 'secret',
               :preparation_method => 'secret')
RecipePhoto.create!(:recipe => recipe3, :title => 'Bhindi', :image => File.open('db/pictures/MeduVada.jpeg'))
